        ...
        <main>
            ...
            <div class="terminy">
                ...
                <?php
                    ...
                    $result=mysqli_query($conn, "SELECT * FROM terminy");

                    while($row=mysqli_fetch_array($result))
                    {
                    echo '<div class="row d-flex terminy__termin">                            
                            <div class="col-4 col-lg-1 offset-lg-1 terminy terminy__termin terminy__termin__nazwa">'.$row['nazwa'].'</div>

                            <div class="col-8 col-lg-5 terminy terminy__termin terminy__termin__definicja">'.$row['definicja'].'</div>
                          </div>';
